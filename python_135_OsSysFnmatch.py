...
#execucao de tarefas para converter os arquivos
...
#---dando os caminhos de entrada e saida
caminho_origem = '\Office\Desktop\media_total\videos'
caminho_destino = '\Office\Desktop\media_total\saida'
...
for raiz, pastas, arquivos in os.walk(caminho_origem):
    for arquivo in arquivos:
        ...
        comando = f'{comando_ffmpeg} -i "{caminho_completo}"{input_legenda}' \
                    ...
                    f'{debug} {map}"{arquivo_saida}"'

        os.system(comando) #execucao do comando
